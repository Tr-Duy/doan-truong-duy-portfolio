    ...
    <header
      className={`sticky top-0 z-50 transition-all duration-200 ${
        scrolled
          ...
          : 'bg-[#F1F5F9]/90 backdrop-blur-sm border-b border-[#CBD5E1]/80'
      }`}
    >
      <div className="max-w-6xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
        ...
        >
          ...
          <div className="flex flex-col text-left">
            <span className="font-bold text-sm text-[#0F172A] tracking-tight leading-tight group-hover:text-blue-600 transition-colors">
              {PORTFOLIO_DATA.personalInfo.name}
            </span>
            <span className="text-[12px] text-[#64748B] font-medium leading-tight">
            ...
            return (
              <a
                ...
                className={`px-3 py-1.5 rounded-lg text-[14px] font-medium transition-colors ${
                  isActive
                    ? 'text-[#1D4ED8] bg-[#EFF6FF] font-semibold border border-[#BFDBFE]'
        ...
        <div className="hidden md:flex items-center gap-2">
          ...
          <a
            ...
            className="p-2 rounded-lg text-[#475569] hover:text-[#0F172A] hover:bg-white border border-[#CBD5E1] transition-colors bg-white/60 shadow-xs"
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="p-2 rounded-lg text-[#475569] hover:text-[#1D4ED8] hover:bg-[#EFF6FF] border border-[#CBD5E1] transition-colors bg-white/60 shadow-xs"
        ...
        <div className="flex md:hidden items-center gap-2">
          ...
          <button
            ...
            className="p-2 rounded-lg border border-[#CBD5E1] bg-white text-[#475569] hover:bg-slate-50 transition-colors"
      ...
      {isMenuOpen && (
        <div className="md:hidden border-b border-[#CBD5E1] bg-white animate-fade-in shadow-md">
          <div className="px-4 pt-2 pb-4 space-y-1">
            ...
            <div className="pt-3 mt-2 border-t border-[#CBD5E1]/60 flex flex-col gap-2">
              <div className="flex items-center gap-2">
                <a
                  href={PORTFOLIO_DATA.personalInfo.github}
                  target="_blank"
                  rel="noopener noreferrer"
                  className="flex-1 flex items-center justify-center gap-2 py-2 px-3 rounded-lg border border-[#CBD5E1] bg-[#F1F5F9] text-[#475569] text-xs font-medium"
                >
                  <GithubIcon className="w-4 h-4" />
                  <span>GitHub</span>
                </a>
